...
const messages = {
    ...
    简体中文: {
        ...
        country_name: {
            ...
            New_Brunswick: '新不伦瑞克',
            Nova_Scotia: '新斯科舍',
            Newfoundland_and_Labrador: '纽芬兰与拉布拉多',
            Nunavut: '努纳武特',
            Northwest_Territories: '西北地区',
            Yukon: '育空',
            Alaska: '阿拉斯加',
            Prince_Edward_Island: '爱德华王子岛',
            Baja_California: '下加利福尼亚',
            Baja_California_Sur: '南下加利福尼亚',
            Sonora: '索诺拉',
            Chihuahua: '奇瓦瓦',
            Coahuila: '科阿韦拉',
            Tamaulipas: '塔毛利帕斯',
    ...
    繁體中文: {
        ...
        country_name: {
            ...
            British_Columbia: '英屬哥倫比亞',
            Alberta: '亞伯達',
            Saskatchewan: '薩克其萬',
            Manitoba: '曼尼托巴',
            Ontario: '安大略',
            Quebec: '魁北克',
            New_Brunswick: '新布藍茲維省',
            Nova_Scotia: '新斯科細亞',
            Newfoundland_and_Labrador: '紐芬蘭與拉布拉多',
            Nunavut: '努納福特',
            Northwest_Territories: '西北地區',
            Yukon: '育空',
            Alaska: '阿拉斯加',
            Prince_Edward_Island: '愛德華王子島',
            Baja_California: '下加利福尼亞',
            Baja_California_Sur: '南下加利福尼亞',
            Sonora: '索諾拉',
            Chihuahua: '契瓦瓦',
            Coahuila: '科阿韋拉',
            Tamaulipas: '塔毛利帕斯',
    ...
    日本語: {
        ...
        country_name: {
            ...
            British_Columbia: 'ブリティッシュコロンビア',
            Alberta: 'アルベータ',
            Saskatchewan: 'サスカチュワン',
            Manitoba: 'マニトバ',
            Ontario: 'オンタリオ',
            Quebec: 'ケベック',
            New_Brunswick: 'ニューブランズウィック',
            Nova_Scotia: 'ノバスコシア',
            Newfoundland_and_Labrador: 'ニューファンドランド・ラブラドール',
            Nunavut: 'ヌナブト準州',
            Northwest_Territories: 'ノースウエスト準州',
            Yukon: 'ユーコン準州',
            Alaska: 'アラスカ',
            Prince_Edward_Island: 'プリンスエドワードアイランド',
            Baja_California: 'バハ・カリフォルニア',
            Baja_California_Sur: 'バハ・カリフォルニア・スル',
            Sonora: 'ソノラ',
            Chihuahua: 'チワワ',
            Coahuila: 'コアヒラ',
            Tamaulipas: 'タマウリパス',
    ...
    French: {
        ...
        country_name: {
            ...
            Baja_California: 'Basse-Californie',
            Baja_California_Sur: 'Basse-Californie-du-Sud',
            Sonora: 'Sonora',
            Chihuahua: 'Chihuahua',
            Coahuila: 'Coahuila',
            Tamaulipas: 'Tamaulipas',
            ...
            Tlaxcala: 'Tlaxcala',
            Puebla: 'Puebla',
            Ciudad_de_México: 'ville de Mexico',
            Morelos: 'Morelos',
            Aguascalientes: 'Aguascalientes',
            Guerrero: 'Guerrero',
            Oaxaca: 'Oaxaca',
...
const 保存等级们 = _=>{
    ...
    本地存储.setItem(美国本地存储钥匙,本地存储value.substring(0,56));
};
const 省等级们正则 = /^[\d|-]{101}$/;
const 美国省等级们正则 = /^[\d|-]{56}$/;
const 获取等级们并生效 = _=>{
    ...
    if(!省等级们正则.test(临时等级们字串)) {
        临时等级们字串 = 本地存储.getItem(美国本地存储钥匙);
        if (美国省等级们正则.test(临时等级们字串))
            for (let i=56;i<101;i++) 临时等级们字串 += '0';
        else return;
    }
    const 等级们字串 = 临时等级们字串;
